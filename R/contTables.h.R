...
#' Contingency Tables (2xK comparative measures)
#'
#' A clone of jmv's Contingency Tables analysis. The X² test of
#' association (not to be confused with the X² goodness of fit) is used
#' to test whether two categorical variables are independent or associated.
#' If the p-value is low, it suggests the variables are not independent, and
#' that there is a relationship between the two variables. Unlike jmv's
#' contTables, the comparative measures (odds ratio, log odds ratio, relative
#' risk, difference in proportions) are available for 2xK tables (not just
#' 2x2), each non-reference category of the compared variable contrasted
#' against a reference category (the first level).
#'
#' @examples
#' data('HairEyeColor')
...
#'   (only available for 2xK tables; each non-reference category of the
#'   compared variable vs. a reference category)
